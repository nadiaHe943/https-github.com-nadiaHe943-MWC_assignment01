...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        stepsCountProgressBar.setMax(1000);
            ...
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                if (group.getCheckedButtonId() == R.id.toggleStart) {
                    ...
                    if(stepDetectorSensor != null) {
                        mSensorManager.registerListener(listener, stepDetectorSensor, SensorManager.SENSOR_DELAY_NORMAL );
                    } else {
...
class StepCounterListener implements SensorEventListener {
    ...
    //TODO 10
    public StepCounterListener (TextView tv, ProgressBar bar) {
        stepsCountTextView = tv;
        stepsCountProgressBar = bar;
    }
    ...
    private void countSteps(float step) {
            if(mAndroidStepCount<1){
                mAndroidStepCount = (int) step;
            }
            Log.d("step", String.valueOf(mAndroidStepCount));
